...
import interfaz_comite

def llamar_login_comite():
    ...
    backgroundimage = PhotoImage(file="imagenes/loginCom.png")
    ...
    def interfaz():
        ...
        if (username=="" or username=="UserID") or (password=="" or password=="Password"): 
            ...
            command = "select * from logincomite where usuario=%s and contrasena=%s"
            ...
            if myresult==None:
                ...
                root.destroy()
                interfaz_comite.llamar_interfaz_comite()

    def return_home():
        messagebox.showinfo("Principal","Redirigiendo a la ventana principal")
        root.destroy()

    loginButton = Button(root,text="Iniciar Sesión", fg="white", border=0, bg="#037770", cursor="hand2", font=(font), command=interfaz, justify="center")
