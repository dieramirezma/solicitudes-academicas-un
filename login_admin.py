...
import interfaz_admin
def llamar_login_admin():
    root = Toplevel()
    ...
    backgroundimage = PhotoImage(file="imagenes/loginAdm.png")
    ...
    def loginuser():
        ...
        if (username=="" or username=="UserID") or (password=="" or password=="Password"): 
            ...
            command = "select * from loginadmin where usuario=%s and contrasena=%s"
            ...
            if myresult==None:
                ...
                root.destroy()
                interfaz_admin.llamar_interfaz_admin()
